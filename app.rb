...
class HandleNewEvolutionaryDesignWithoutTestsBookingApp < Sinatra::Base
  post '/booking/email-notification' do
    return [500, {},
            ["I can't find the booking details destination endpoint URL."]] unless BookingDetailsDestinationEndpointUrl
    ...
    if booking_details
      ...
      HTTParty.post(BookingDetailsDestinationEndpointUrl,
                    { body: { customer_email: booking_details.customer_email,
                              customer_full_name: booking_details.customer_full_name } })
      200
    else
