...
def parse_flexbooker_email_body_plain(email_body_plain)
  EvolutionaryDesignWithTestsBooking.parse_flexbooker_email_body_plain(email_body_plain)
end
...
describe "Parsing the Flexbooker booking notification email body" do
    example "a realistic example from a real booking email" do
        ...
        booking = parse_flexbooker_email_body_plain(realistic_email_body_plain)
